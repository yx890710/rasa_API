...
#en_rasa_chat_url = "http://ip:5006/model/parse"
...
def rasa_run_en_model():
    ...
    global en_nlu_model
    en_cmd="rasa run -m {} --enable-api --log-file out_en.log -p 5006".format(en_nlu_model)
    #使用shlex.split()拆解指令列
...
def model_change():
    ...
    #en_nlu_model=get_latest_model(model_list[1])
    ...
    try:
        ...
        en_cmd="rasa run -m {} --enable-api --log-file out.log -p 5006".format(en_nlu_model)
        en_args = shlex.split(en_cmd)
        print(en_args)
